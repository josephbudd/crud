...
func (tools *Tools) initializeGroups() {
	...
	panel = tools.NotJS.GetElementByID("tabsMasterView-home-pad-AddButton-AddPanel")
	if panel == js.Undefined() {
		message := "viewtools.initializeGroups: Cant find #tabsMasterView-home-pad-AddButton-AddPanel"
	...
	tools.buttonPanelsMap[buttonid] = make([]js.Value, 0, 5)
	panel = tools.NotJS.GetElementByID("tabsMasterView-home-pad-EditButton-EditFormPanel")
	if panel == js.Undefined() {
		message := "viewtools.initializeGroups: Cant find #tabsMasterView-home-pad-EditButton-EditFormPanel"
		tools.alert.Invoke(message)
		return
	}
	tools.buttonPanelsMap[buttonid] = append(tools.buttonPanelsMap[buttonid], panel)
	panel = tools.NotJS.GetElementByID("tabsMasterView-home-pad-EditButton-EditNotReadyPanel")
	if panel == js.Undefined() {
		message := "viewtools.initializeGroups: Cant find #tabsMasterView-home-pad-EditButton-EditNotReadyPanel"
		tools.alert.Invoke(message)
		return
	}
	tools.buttonPanelsMap[buttonid] = append(tools.buttonPanelsMap[buttonid], panel)
	panel = tools.NotJS.GetElementByID("tabsMasterView-home-pad-EditButton-EditSelectPanel")
	if panel == js.Undefined() {
		message := "viewtools.initializeGroups: Cant find #tabsMasterView-home-pad-EditButton-EditSelectPanel"
		tools.alert.Invoke(message)
		return
	}
	tools.buttonPanelsMap[buttonid] = append(tools.buttonPanelsMap[buttonid], panel)
	// Remove RemoveButton button.
	buttonid = "tabsMasterView-home-pad-RemoveButton"
	tools.buttonPanelsMap[buttonid] = make([]js.Value, 0, 5)
	panel = tools.NotJS.GetElementByID("tabsMasterView-home-pad-RemoveButton-RemoveFormPanel")
	if panel == js.Undefined() {
		message := "viewtools.initializeGroups: Cant find #tabsMasterView-home-pad-RemoveButton-RemoveFormPanel"
		tools.alert.Invoke(message)
		return
	}
	tools.buttonPanelsMap[buttonid] = append(tools.buttonPanelsMap[buttonid], panel)
	panel = tools.NotJS.GetElementByID("tabsMasterView-home-pad-RemoveButton-RemoveNotReadyPanel")
	if panel == js.Undefined() {
		message := "viewtools.initializeGroups: Cant find #tabsMasterView-home-pad-RemoveButton-RemoveNotReadyPanel"
		tools.alert.Invoke(message)
		return
	}
	tools.buttonPanelsMap[buttonid] = append(tools.buttonPanelsMap[buttonid], panel)
	panel = tools.NotJS.GetElementByID("tabsMasterView-home-pad-RemoveButton-RemoveSelectPanel")
	if panel == js.Undefined() {
		message := "viewtools.initializeGroups: Cant find #tabsMasterView-home-pad-RemoveButton-RemoveSelectPanel"
		tools.alert.Invoke(message)
		return
	}
	tools.buttonPanelsMap[buttonid] = append(tools.buttonPanelsMap[buttonid], panel)
