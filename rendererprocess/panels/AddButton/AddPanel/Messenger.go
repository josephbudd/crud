...
func (messenger *panelMessenger) addContact(r *record.Contact) {
...
func (messenger *panelMessenger) addContactRX(msg *message.AddContactMainProcessToRenderer) {
	if msg.Error {
		display.Error(msg.ErrorMessage)
		return
	}
