...
var (
	...
	panelNameHVScroll = map[string]bool{"AddPanel":false, "EditFormPanel":false, "EditNotReadyPanel":false, "EditSelectPanel":false, "PrintNotReadyPanel":false, "PrintPrintPanel":false, "PrintSelectPanel":false, "RemoveFormPanel":false, "RemoveNotReadyPanel":false, "RemoveSelectPanel":false}

	// markup panels

	countMarkupPanels = 10
