...
func (controller *panelController) defineControlsHandlers() (err error) {
	...
	*/
	...
	controller.printBack.SetEventHandler(controller.handleBack, "click", false)
	...
	controller.printPrintAs.SetEventHandler(controller.handlePrint, "click", false)
...
func (controller *panelController) handleBack(e event.Event) (nilReturn interface{}) {
	// Go back to the print select panel.
	controller.group.showPrintSelectPanel(false)
	return
}

func (controller *panelController) handlePrint(e event.Event) (nilReturn interface{}) {
	display.Print(documentPrintTitle)
	return
}
