...
var (
	homeNames = []string{"AddButton", "EditButton", "RemoveButton", "PrintButton"}

	buttonNamePanelNames = map[string][]string{"AddButton":[]string{"AddPanel"}, "EditButton":[]string{"EditNotReadyPanel", "EditSelectPanel", "EditFormPanel"}, "PrintButton":[]string{"PrintNotReadyPanel", "PrintSelectPanel", "PrintPrintPanel"}, "RemoveButton":[]string{"RemoveNotReadyPanel", "RemoveSelectPanel", "RemoveFormPanel"}}
