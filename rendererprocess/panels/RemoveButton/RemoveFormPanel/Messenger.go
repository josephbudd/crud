...
func (messenger *panelMessenger) removeContact(id uint64) {
...
func (messenger *panelMessenger) removeContactRX(msg *message.RemoveContactMainProcessToRenderer) {
	if msg.Error {
		display.Error(msg.ErrorMessage)
		return
	}
	display.Success("Contact Removed.")
}
