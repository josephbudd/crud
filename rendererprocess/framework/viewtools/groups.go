...
func initializeGroups() {
	...
	buttonid = "mainMasterView-home-pad-AddButton"
	buttonPanelsMap[buttonid] = make([]js.Value, 0, 5)
	panel = getElementByID(document, "mainMasterView-home-pad-AddButton-AddPanel")
	if panel == js.Undefined() {
		message := "viewtools.initializeGroups: Cant find #mainMasterView-home-pad-AddButton-AddPanel"
		alert.Invoke(message)
		return
	}
	buttonPanelsMap[buttonid] = append(buttonPanelsMap[buttonid], panel)
	// EditButton EditButton button.
	buttonid = "mainMasterView-home-pad-EditButton"
	buttonPanelsMap[buttonid] = make([]js.Value, 0, 5)
	panel = getElementByID(document, "mainMasterView-home-pad-EditButton-EditFormPanel")
	if panel == js.Undefined() {
		message := "viewtools.initializeGroups: Cant find #mainMasterView-home-pad-EditButton-EditFormPanel"
		alert.Invoke(message)
		return
	}
	buttonPanelsMap[buttonid] = append(buttonPanelsMap[buttonid], panel)
	panel = getElementByID(document, "mainMasterView-home-pad-EditButton-EditNotReadyPanel")
	if panel == js.Undefined() {
		message := "viewtools.initializeGroups: Cant find #mainMasterView-home-pad-EditButton-EditNotReadyPanel"
		alert.Invoke(message)
		return
	}
	buttonPanelsMap[buttonid] = append(buttonPanelsMap[buttonid], panel)
	panel = getElementByID(document, "mainMasterView-home-pad-EditButton-EditSelectPanel")
	if panel == js.Undefined() {
		message := "viewtools.initializeGroups: Cant find #mainMasterView-home-pad-EditButton-EditSelectPanel"
		alert.Invoke(message)
		return
	}
	buttonPanelsMap[buttonid] = append(buttonPanelsMap[buttonid], panel)
	// PrintButton PrintButton button.
	buttonid = "mainMasterView-home-pad-PrintButton"
	buttonPanelsMap[buttonid] = make([]js.Value, 0, 5)
	panel = getElementByID(document, "mainMasterView-home-pad-PrintButton-PrintNotReadyPanel")
	if panel == js.Undefined() {
		message := "viewtools.initializeGroups: Cant find #mainMasterView-home-pad-PrintButton-PrintNotReadyPanel"
		alert.Invoke(message)
		return
	}
	buttonPanelsMap[buttonid] = append(buttonPanelsMap[buttonid], panel)
	panel = getElementByID(document, "mainMasterView-home-pad-PrintButton-PrintPrintPanel")
	if panel == js.Undefined() {
		message := "viewtools.initializeGroups: Cant find #mainMasterView-home-pad-PrintButton-PrintPrintPanel"
		alert.Invoke(message)
		return
	}
	buttonPanelsMap[buttonid] = append(buttonPanelsMap[buttonid], panel)
	panel = getElementByID(document, "mainMasterView-home-pad-PrintButton-PrintSelectPanel")
	if panel == js.Undefined() {
		message := "viewtools.initializeGroups: Cant find #mainMasterView-home-pad-PrintButton-PrintSelectPanel"
		alert.Invoke(message)
		return
	}
	buttonPanelsMap[buttonid] = append(buttonPanelsMap[buttonid], panel)
	// RemoveButton RemoveButton button.
	buttonid = "mainMasterView-home-pad-RemoveButton"
	buttonPanelsMap[buttonid] = make([]js.Value, 0, 5)
	panel = getElementByID(document, "mainMasterView-home-pad-RemoveButton-RemoveFormPanel")
	if panel == js.Undefined() {
		message := "viewtools.initializeGroups: Cant find #mainMasterView-home-pad-RemoveButton-RemoveFormPanel"
		alert.Invoke(message)
		return
	}
	buttonPanelsMap[buttonid] = append(buttonPanelsMap[buttonid], panel)
	panel = getElementByID(document, "mainMasterView-home-pad-RemoveButton-RemoveNotReadyPanel")
	if panel == js.Undefined() {
		message := "viewtools.initializeGroups: Cant find #mainMasterView-home-pad-RemoveButton-RemoveNotReadyPanel"
		alert.Invoke(message)
		return
	}
	buttonPanelsMap[buttonid] = append(buttonPanelsMap[buttonid], panel)
	panel = getElementByID(document, "mainMasterView-home-pad-RemoveButton-RemoveSelectPanel")
	if panel == js.Undefined() {
		message := "viewtools.initializeGroups: Cant find #mainMasterView-home-pad-RemoveButton-RemoveSelectPanel"
		alert.Invoke(message)
		return
	}
	buttonPanelsMap[buttonid] = append(buttonPanelsMap[buttonid], panel)
