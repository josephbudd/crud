...
var serviceEmptyInsidePanelNamePathMap = map[string]map[string][]string{"Add": map[string][]string{"AddPanel": []string{"AddButton"}}, "Edit": map[string][]string{"EditFormPanel": []string{"EditButton"}, "EditNotReadyPanel": []string{"EditButton"}, "EditSelectPanel": []string{"EditButton"}}, "Remove": map[string][]string{"RemoveFormPanel": []string{"RemoveButton"}, "RemoveNotReadyPanel": []string{"RemoveButton"}, "RemoveSelectPanel": []string{"RemoveButton"}}}
...
func serveMainHTML(w http.ResponseWriter) {
	...
	if bb, found = crudsitepack.Contents(tpath); !found {
