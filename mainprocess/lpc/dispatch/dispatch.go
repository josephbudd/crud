...
func Do(ctx context.Context, cargo interface{}, sending lpc.Sending, stores *store.Stores, errChan chan error) {
	...
	case *message.AddContactRendererToMainProcess:
		handleAddContact(ctx, cargo, sending, stores, errChan)
	case *message.EditContactRendererToMainProcess:
		handleEditContact(ctx, cargo, sending, stores, errChan)
	case *message.GetEditContactRendererToMainProcess:
		handleGetEditContact(ctx, cargo, sending, stores, errChan)
	case *message.GetEditSelectContactsPageRendererToMainProcess:
		handleGetEditSelectContactsPage(ctx, cargo, sending, stores, errChan)
	case *message.GetPrintContactRendererToMainProcess:
		handleGetPrintContact(ctx, cargo, sending, stores, errChan)
	case *message.GetPrintSelectContactsPageRendererToMainProcess:
		handleGetPrintSelectContactsPage(ctx, cargo, sending, stores, errChan)
	case *message.GetRemoveContactRendererToMainProcess:
		handleGetRemoveContact(ctx, cargo, sending, stores, errChan)
	case *message.GetRemoveSelectContactsPageRendererToMainProcess:
		handleGetRemoveSelectContactsPage(ctx, cargo, sending, stores, errChan)
	case *message.ReloadContactsRendererToMainProcess:
		handleReloadContacts(ctx, cargo, sending, stores, errChan)
	case *message.RemoveContactRendererToMainProcess:
		handleRemoveContact(ctx, cargo, sending, stores, errChan)
	default:
